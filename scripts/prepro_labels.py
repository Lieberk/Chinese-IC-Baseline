...
def main(params):
    ...
    attr_vocab = build_attr_vocab(vocab)
    attr_itow = {i + 1: w for i, w in enumerate(attr_vocab)}  # a 1-indexed vocab translation table
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
      ...
      # input json
    parser.add_argument('--input_json', default='../filelists/flickr8k-cn/dataset_flickr8k_cn.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='../filelists/flickr8k.json', help='output json file')
    parser.add_argument('--output_h5', default='../filelists/flickr8k', help='output h5 file')
